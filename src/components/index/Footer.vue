  ...
  <footer class="ui inverted vertical segment m-padded-tb-large m-opacity">
    <div class="ui center aligned container">
      ...
      <p class="m-text-thin m-text-spaced m-opacity-tiny">
        ...
        <span style="margin: 0 15px" v-if="siteInfo.copyright && siteInfo.icp">|</span>
        <a rel="external nofollow noopener" href="https://beian.miit.gov.cn/" target="_blank" style="color:#ffe500">{{
          siteInfo.icp }}</a>
      </p>
