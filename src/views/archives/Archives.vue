<template>
  <div>
    <div class="ui top attached segment" style="text-align: center">
      ...
      <p>好! 目前共计 {{ total }} 篇日志。 继续努力。</p>
    </div>
    <div class="ui attached segment">
      <div class="timeline">
        <div :class="colorObj[index % 5]" v-for="(group, index) in groups" :key="index">
          <div class="tl-header">
            <a class="ui large label m-text-500">{{ group.dateGroup }}</a>
          </div>
          <div class="tl-item" v-for="blog in group.blogs" :key="blog.id">
            <div class="tl-wrap">
