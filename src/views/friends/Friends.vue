<template>
  <div>
    ...
    <div class="ui teal attached segment">
      <div class="typo content" v-viewer v-html="content"></div>
    </div>
    <!--评论-->
    <div class="ui bottom teal attached segment threaded comments">
      <CommentList :page="2" :blogId="null" v-if="commentEnabled" />
...
<script>
import { pageFriend, friendClick } from "@/api/friend";
    ...
    getData () {
      pageFriend().then(res => {
        if (res.code === 200) {
          ...
          this.commentEnabled = res.data.commentEnabled
        } else {
